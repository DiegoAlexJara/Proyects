...
class MarcaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $Marca->color = '#c20000';
        $Marca->path = 'img/comic/products/Marvel.jpg';
        $Marca->save();
        ...
        $Marca->color = '#0017c2';
        $Marca->path = 'img/comic/products/DC Comics.jpg';
        $Marca->save();
        ...
        $Marca->color = '#0000';
        $Marca->path = 'img/comic/products/Image Comics.jpg';
        $Marca->save();
        ...
        $Marca->color = '#6a6a6c';
        $Marca->path = 'img/comic/products/DARK HORSE COMIC.jpg';
        $Marca->save();
        ...
        $Marca->color = '#ff8000';
        $Marca->path = 'img/comic/products/VIZ MEDIA.jpg';
        $Marca->save();
        ...
        $Marca->color = '#16ff05';
        $Marca->path= 'img/comic/products/kodansha.jpg';
        $Marca->save();
        ...
        $Marca->color = '#ffea05';
        $Marca->path= 'img/comic/products/SHUEISHA.jpg';
        $Marca->save();
        ...
        $Marca->color = '#d116d4';
        $Marca->path= 'img/comic/products/Tokyopop.jpg';
        $Marca->save();
        ...
        $Marca->color = '#a3a3a3';
        $Marca->path= 'img/comic/products/yen press.jpg';
        $Marca->save();
        ...
        $Marca->color = '#ff0000';
        $Marca->path= 'img/comic/products/panini Manga.jpg';
        $Marca->save();
    }
}
