        ...
        <div class="overlay-square">
            <div style="display: flex">
                ...
                <div style="width: 10%; text-align: right">
                    <button class="btn btn-danger" wire:click='CategoriaNueva'>X</button>
                </div>
            </div>
            <form wire:submit.prevent='save'>
                <div class="mb-3">
                    ...
                    <input type="text"class="form-control" name="Name" wire:model='formData.name'
                        value="{{ old('Name') }}" placeholder="Nombre De La Categoria">
                    @error('formData.name')
                        <p>{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" cols="30" rows="10" class="form-control"
                        ...
                        style="width: 100%; height: 80px; resize: none; border: .5px solid black" placeholder="Descripcion De La Categoria">
                        {{ old('description') }}
                    </textarea>
    ...
    @if ($editCategoria)
        ...
        <div class="overlay-square">
            <div style="display: flex">
                ...
                <div style="width: 10%; text-align: right">
                    <button class="btn btn-danger" wire:click='EditarCategoria'>X</button>
                </div>
            </div>
