...
<body>
    <div class="login-container">
        ...
        <form method="POST" action="{{ route('finanza_LoginIn') }}">
            @csrf
            <div class="form-group">
                <label for="email" style="color: black">Correo electrónico</label>
                <input type="email" id="email" name="email" value="{{ old('email') ?? 'visitante@gmail.com' }}"
                    required autofocus
        ...
        <div class="footer">
            <p>¿No tienes cuenta? <a href="{{ route('finanza_NewUser') }}">Regístrate</a></p>
        </div>
    </div>
    <script>
