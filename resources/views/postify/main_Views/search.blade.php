...
<head>
    ...
    {{-- ESTILOS --}}
    <link rel="stylesheet" href="{{ asset('css/postify/search.css') }}">
...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <a href="{{ route('postify_Inicio') }}" class="dropdown-item">
                <img src="{{ asset('img/postify/return.png') }}" alt="Regresar" class="return-icon">
            </a>

            <!-- Formulario de búsqueda de usuario -->
            <form action="{{ route('postify_search') }}" method="GET" class="search-form">
            ...
            <div class="user-cards">
                @foreach ($users as $user)
                    <div class="user-card">
                        ...
                        <a href="{{ route('postify_visit', $user->name) }}" class="view-button">Ver Usuario</a>
                    </div>
                @endforeach
            </div>
        @else
